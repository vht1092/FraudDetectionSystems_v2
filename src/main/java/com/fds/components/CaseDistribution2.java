...
@SpringComponent
@Scope("prototype")
public class CaseDistribution2 extends CustomComponent implements ReloadAutoComponent, ReloadComponent {

	private static final long serialVersionUID = 1L;
	public static final String CAPTION = "CASE FB ĐANG CHỜ XỬ LÝ";
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CaseDistribution2.class);

	public CaseDistribution2() {
		setCaption(CAPTION);
	...
	private Page<FdsCaseDetail> getData(Pageable page) {
		...
		result = caseDetailService.findAllBycheckNewAndMerc(page);
