...
@SpringComponent
@Scope("prototype")
public class ClosedCase extends CustomComponent implements ReloadComponent {
	...
	public static final String CAPTION = "CASE ĐÃ ĐÓNG";
	...
	private Page<FdsCaseDetail> getData(Pageable page) {
		if("4".equals(CheckUserId)) {
			result = caseDetailService.findAllClosed(page);
		} else {
