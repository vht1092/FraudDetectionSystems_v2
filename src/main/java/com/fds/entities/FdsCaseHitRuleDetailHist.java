...
/**
 * The persistent class for the FDS_CASE_HIT_RULE_DETAIL_HIST database table.
 * 
 */
@Entity
@Table(name="FDS_CASE_HIT_RULE_DETAIL_HIST")
@NamedQuery(name="FdsCaseHitRuleDetailHist.findAll", query="SELECT f FROM FdsCaseHitRuleDetailHist f")
public class FdsCaseHitRuleDetailHist implements Serializable {
	...
	public FdsCaseHitRuleDetailHist() {
	}
