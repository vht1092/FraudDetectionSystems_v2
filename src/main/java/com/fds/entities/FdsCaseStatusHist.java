...
/**
 * The persistent class for the FDS_CASE_STATUS_HIST database table.
 * 
 */
@Entity
@Table(name = "FDS_CASE_STATUS_HIST")
@VaadinSessionScope
public class FdsCaseStatusHist implements Serializable {
