...
/**
 * The persistent class for the FDS_CASE_DETAIL_HIST database table.
 */
@Entity
@Table(name = "FDS_CASE_DETAIL_HIST")
@NamedQuery(name = "FdsCaseDetailHist.findAll", query = "SELECT f FROM FdsCaseDetailHist f")
public class FdsCaseDetailHist implements Serializable {
	...
	@JoinTable(name = "FDS_CASE_HIT_RULES_HIST", joinColumns = { @JoinColumn(name = "CASE_NO", nullable = false) }, inverseJoinColumns = {
			@JoinColumn(name = "RULE_ID", nullable = false) })
	private List<FdsRule> fdsRules;

	public FdsCaseDetailHist() {
	}
