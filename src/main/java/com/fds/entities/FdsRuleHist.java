...
/**
 * The persistent class for the FDS_RULES_HIST database table.
 * 
 */
@Entity
@Table(name = "FDS_RULES_HIST")
@NamedQuery(name = "FdsRuleHist.findAll", query = "SELECT f FROM FdsRuleHist f")
public class FdsRuleHist implements Serializable {
