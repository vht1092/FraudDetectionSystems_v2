...
public class CaseDetailServiceImpl implements CaseDetailService {
	...
	public Page<FdsCaseDetail> findAllBycheckNewIsAndNotMerc(Pageable page) {
		return caseDetailRepo.findAllBycheckNewIsAndNotMerc("Y","FACEBK", page);
	}
	
	@Override
	public Page<FdsCaseDetail> findAllBycheckNewAndMerc(Pageable page) {
		return caseDetailRepo.findAllBycheckNewIsAndMerc("Y","FACEBK", page);
	}
	...
	@Override
	//tanvh1
//	@Cacheable(value = "FdsCaseDetail.getDed2A", key = "#cardno")
	...
	public int updateStatusCaseClear(String user, BigDecimal fromdate, BigDecimal todate) {
		return caseDetailRepo.updateStatusCaseClear(user, fromdate, todate);
	}
